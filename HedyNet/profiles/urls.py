...
urlpatterns = patterns('',
    url(r'^directory$', views.MemberDirectoryView.as_view(), name="memberdirectory"),
    ...
    url(r'^user/(?P<username>\w+)/email/(?P<pk>\d+)/delete$', views.UserEmailDeleteView.as_view(), name="user_profile_email_delete"),
)

urlpatterns += patterns('',
    url(r'^admin/memberstatuslist$', views.MemberStatusListView.as_view(), name="member_status_list_admin"),
    url(r'^admin/memberstatuschange/(?P<username>\w+)/add$', views.MemberStatusChangeCreateView.as_view(), name="member_status_change_add"),
    url(r'^admin/memberstatuschange/(?P<username>\w+)/(?P<pk>\d+)$', views.MemberStatusChangeDetailView.as_view(), name="member_status_change_detail"),
    url(r'^admin/memberstatushistory/(?P<username>\w+)$', views.MemberStatusChangeListView.as_view(), name="member_status_change_list"),
)
