...
urlpatterns = patterns('',
    ...
    url(r'^user/(?P<username>[\w.@+-]+)/site/(?P<pk>\d+)$',
        views.UserExternalSiteDetailView.as_view(), name="user_profile_site_detail"),
    ...
    url(r'^user/(?P<username>[\w.@+-]+)/site/add$',
        views.UserExternalSiteCreateView.as_view(), name="user_profile_site_add"),
    ...
    url(r'^user/(?P<username>[\w.@+-]+)/site/(?P<pk>\d+)/update$',
        views.UserExternalSiteUpdateView.as_view(), name="user_profile_site_update"),
    ...
    url(r'^user/(?P<username>[\w.@+-]+)/site/(?P<pk>\d+)/delete$',
        views.UserExternalSiteDeleteView.as_view(), name="user_profile_site_delete"),
)
